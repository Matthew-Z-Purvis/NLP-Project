...
def evaluate_model(model_file="plebe_classifier.pkl"):
    """
    Load the saved model and evaluate it to find false positives and false negatives.
...
evaluate_model(model_file="plebe_classifier.pkl")
